  ...
  return (
    <div className="relative mx-auto max-w-2xl px-6 py-10">
      ...
      <blockquote className="space-y-3 text-center">
        <p className="font-[family-name:var(--font-proposal-display)] text-sm font-medium tracking-[0.25em] text-stone-500 uppercase">
          A note from your concierge
        </p>
        <p className="font-[family-name:var(--font-proposal-display)] text-2xl leading-relaxed text-stone-700 italic md:text-3xl">
          &ldquo;{note}&rdquo;
        </p>
      </blockquote>
    </div>
  ...
  return (
    <main className="flex min-h-full flex-col items-center justify-center px-6 py-24 text-center">
      <div className="max-w-md space-y-4">
        <p className="font-[family-name:var(--font-proposal-display)] text-base tracking-[0.3em] text-stone-500 uppercase">
          Villa Concierge
        </p>
        <h1 className="font-[family-name:var(--font-proposal-display)] text-4xl font-medium text-stone-800 md:text-5xl">
...
export function MemberProposalConfirmed({
  ...
  return (
    <div className="mt-12 rounded-2xl border border-stone-200 bg-white/90 px-8 py-12 text-center shadow-sm shadow-stone-200/60">
      ...
      <h2 className="font-[family-name:var(--font-proposal-display)] text-4xl font-medium text-stone-900 md:text-5xl">
      ...
      <div className="mt-8 border-t border-stone-100 pt-6">
        ...
        <p className="mt-2 font-[family-name:var(--font-proposal-display)] text-5xl font-medium text-stone-900 tabular-nums">
          {formatPriceDetailed(total)}
        </p>
      </div>
    </div>
...
export function MemberProposalActionButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="rounded-full border border-stone-800 bg-stone-900 px-10 py-3.5 font-[family-name:var(--font-proposal-display)] text-xl tracking-wide text-stone-50 transition-all hover:bg-stone-800 disabled:cursor-not-allowed disabled:opacity-60"
    >
      {children}
    </button>
  );
